...
#SBATCH --chdir=/home/lc3616/Projects/Mnist_v7_sbatch/slurm-for-ml-master
...
mv "slurm_jobs/slurm-${JOB_ID}.out" "${JOB_OUTPUT}/"
mv "slurm_jobs/slurm-${JOB_ID}.err" "${JOB_OUTPUT}/" 2>/dev/null || true
