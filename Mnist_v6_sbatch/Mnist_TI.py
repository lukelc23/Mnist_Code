...
from Projects.Mnist_v6_sbatch.TransitiveTrainDataset import TransitiveTrainDataset
from Projects.Mnist_v6_sbatch.TransitiveTrainDataset_Exp import TransitiveTrainDataset_Exp
from Projects.Mnist_v6_sbatch.TransitiveTestDataset import TransitiveTestDataset

from Projects.Mnist_v6_sbatch.TI_utils import evaluate_by_pair
import pandas as pd
import json
...
def main():
    ...
    if args.exception == 'false':
        ...
        train_dataset = TransitiveTrainDataset_Exp(mnist_train, n=8)
