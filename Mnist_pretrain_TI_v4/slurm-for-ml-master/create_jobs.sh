...
dataset=$1
script="$HOME/Projects/Mnist_TI/Mnist_pretrain_TI_v4/Mnist_TI.py"
origin_folder="/mnt/smb/locker/abbott-locker/Luke/Mnist/Mnist_pretrain_TI_v4"
pretrained_model="$HOME/Projects/Mnist_TI/Mnist_pretrain_TI_v4/mnist_cnn.pt"
n_items=9
exception_pair="5 3"
